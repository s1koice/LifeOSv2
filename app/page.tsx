...
function CreateModal({kind,accounts,projects,goals,areas,categories,initialProjectId,initialHabit,initialTask,initialGoal,onClose,onCreate}:{kind:Exclude<ModalKind,null>;accounts:Account[];projects:Project[];goals:Goal[];areas:LifeArea[];categories:FinanceCategory[];initialProjectId:number|null;initialHabit:Habit|null;initialTask:Task|null;initialGoal:Goal|null;onClose:()=>void;onCreate:(draft:Record<string,unknown>)=>void}){
