...
export default function Home() {
  ...
  useEffect(() => {
    if (loaded) localStorage.setItem("nexus-state", JSON.stringify({ tasks, projects, inboxItems, resources, goals, habits, lifeAreas, financeCategories, budgetLines, recurringExpenses, habitHistory, accounts, transactions, events, planningNote, healthNotes, journalEntries }));
  }, [loaded, tasks, projects, inboxItems, resources, goals, habits, lifeAreas, financeCategories, budgetLines, recurringExpenses, habitHistory, accounts, transactions, events, planningNote, healthNotes, journalEntries]);
